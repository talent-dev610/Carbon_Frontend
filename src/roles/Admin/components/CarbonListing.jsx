  ...
  return (
    <div className="bg-white rounded-md p-5">
      <div className="space_sty">
        {/* <div className="user_search flex_sty w-90" style={{ width: "70%" }}> */}
        <div className="flex_sty bg-white border-solid border border-[#d3d3d3] text-sm py-2 px-5 text-[#898a8d] rounded ">
